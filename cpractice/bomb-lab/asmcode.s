...
0000000000400da0 <main>:
  ...
  ;; compares the given input string to the string pointed stored at 0x402400
  ;; simply read the value of esi at the strings_not_equal() call to get the answer
0000000000400ee0 <phase_1>:
  ...
  ;; function expects input string to be composed of 6 numbers separated by spaces
  ;; lines 400f17 through 400f1e tell us that each number needs to be double the previous one
0000000000400efc <phase_2>:
  ;; trying to save base pointer register rbp and rbx
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  ;; stack contains rbx<-rbpx<-returnadd...

  ;; allocates 40 (16x2 + 8) words on the stack for something?
  400efe:	48 83 ec 28          	sub    $0x28,%rsp
  ;; stores this new stack pointer address into rsi
  ;; (storing the return address perhaps?)
  400f02:	48 89 e6             	mov    %rsp,%rsi
  ;; remember that %rsi is usually the second integer argument to the function
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers>
  ;; compares the value stored at the top of the stack to 1
  ;; (does this function return an array of numbers?
  ;; Is this line just a NULL pointer check?
  ;; Also, the function returns 1 for more than 5 numbers read from the input line)
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)
  ;; don't detonate bomb if these values are equal
  400f0e:	74 20                	je     400f30 <phase_2+0x34> ;GOTO JUMP 1
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34> ;GOTO JUMP 1

  ;; JUMP 2

  ;; subtract 4 bytes from rbx and store it into eax
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  ;; double the value of eax
  400f1a:	01 c0                	add    %eax,%eax
  ;; compare the value of eax to the address of rbx
  400f1c:	39 03                	cmp    %eax,(%rbx)
  ;; don't detonate the bomb if these values are equal
  ...
  ;; GOTO JUMP 2 if not equal, else GOTO END
  ...
  ;; offset stack pointer by 4 bytes and store the value into rbx
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
  ;; offset stack pointer by 24 bytes and store the value in rbp
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp
  ;; goto JUMP 2
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> ;GOTO JUMP 2

  ;; END

  400f3c:	48 83 c4 28          	add    $0x28,%rsp
  ;; pops the values back into rbp and rbx
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	ret    


  ;; phase 3 expect a pair of numbers as input, separated by a space [n1 n2]
  ;; n1 must be [0, 6]. For each value of n1, there's a corresponding correct value
  ;; of n2. These pairs map as follows:
  ;; (0, 207), (1, 311), (2, 707), (3, 256), (4, 389), (5, 206), (6, 682), (7, 327)
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx ;stores N2
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx ;stores N1
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi
  ;; function call to sscanf() expects the input string to have 2 numbers
  ;; the extracted numbers are stored on the stack itself
  ;; let us call the numbers N1 and N2 from here on
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  ;; check if call to sscanf() succeeded
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> ;GOTO JUMP 1
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  ;; JUMP 1
  ;; checks if N1 is less than equal to 7
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> ;GOTO EXPLODE
  ;; store N1 into eax
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax ;solution for when N1 = 0
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax ;solution for when N1 = 2
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax ;solution for when N1 = 3
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax ;solution for when N1 = 4
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax ;solution for when N1 = 5
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax ;solution for when N1 = 6
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax ;solution for when N1 = 7
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  ;; EXPLODE
  400fad:	e8 88 04 00 00       	call   40143a <explode_bomb>
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax ;solution for when N1 = 1
...
0000000000400fce <func4>:
  ;; upon first function call, these are the register values
  ;; edx = 14 (set manually by phase_4)
  ;; esi = 0 (set manually by phase_4)
  ;; edi = N1 (number scanned by sscanf() in phase_4)
  400fce:	48 83 ec 08          	sub    $0x8,%rsp ;allocate space on stack
  400fd2:	89 d0                	mov    %edx,%eax ;eax = 14 (we store 14 into edx before the call)
  400fd4:	29 f0                	sub    %esi,%eax ;eax = 14 (since we set esi to zero before)
  400fd6:	89 c1                	mov    %eax,%ecx ;ecx = 14
  ;; logical shift on ecx doesn't preserve the sign bit
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx ;ecx = 0 (since ecx >> 31 will zero it out)
  400fdb:	01 c8                	add    %ecx,%eax  ;eax = 14 (eax = eax + ecx)
  ;; arithmetic shift on eax preserves the sign bit of the number
  400fdd:	d1 f8                	sar    %eax       ;eax = 7 (14 >> 1)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx ;ecx = rax (=eax = 7) + rsi (=esi = 0)
  400fe2:	39 f9                	cmp    %edi,%ecx          ;result = 7 - N1
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> ;GOTO JUMP 1 if N1 >= 7
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx     ;N2 = N1 - 7
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx ;result = ecx - edi
  400ff9:	7d 0c                	jge    401007 <func4+0x39> ;GOTO END if ecx >= edi
  ...
  ;; phase 4 expects 2 numbers from the user.
  ;; second number has to be zero (???) - not sure since fun4 changes the value of N2
  ;; (7, 0) (1, 0)
000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx ;stores N2
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx ;stores N1
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi ;stores "%d %d" into esi
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax      ;zeroes eax
  ;; call sscanf() to extract 2 numbers from input string
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29> ;GOTO EXPLODE 1
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)        ;compares N1 to 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e> ;GOTO JUMP 1 if N1 <= 14 (?)
  ;; EXPLODE 1
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  ;; JUMP 1
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx ;store 14 into edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi ;zeroes esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi ;move N1 to edi
  401048:	e8 81 ff ff ff       	call   400fce <func4> ;GOTO func4
  40104d:	85 c0                	test   %eax,%eax      ;eax AND eax
  ;; will explode if function returns non-zero value
  40104f:	75 07                	jne    401058 <phase_4+0x4c> ;GOTO EXPLODE 2
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)        ;checks if N2 is zero (?)
  401056:	74 05                	je     40105d <phase_4+0x51> ;GOTO END
  ;; EXPLODE 2
  ...
  ;; phase 5 expects a six letter string, the contents of which map onto the string
  ;; contained at location 0x4024b0 (maduiersnfotvbyl). The characters a-z are mapped
  ;; one-to-one onto this string string at the second character. Any overflow simply
  ;; wraps back around to the beginning and continues from there.
  ;; So a string 'abcdef' will get converted to 'aduier". A string of all b's 'bbbbbb'
  ;; will convert to 'dddddd', and so on.
  ;; The resulting solution string the function expects should spell "flyers". This
  ;; can be constructed by passing "ionefg" as input.
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx ;saves RBX for later
  401063:	48 83 ec 20          	sub    $0x20,%rsp ;allocates space on the stack
  401067:	48 89 fb             	mov    %rdi,%rbx  ;moves input string to RBX
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax ;moves some data from FS segment into RAX
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp) ;moves RAX onto the stack
  401078:	31 c0                	xor    %eax,%eax       ;zeroes the EAX register
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> ;calls function string_length (and not strlen?)
  40107f:	83 f8 06             	cmp    $0x6,%eax              ;checks if string length equals 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>  ;GOTO JUMP 1
  ;; EXPLODE 1
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70> ;GOTO JUMP 1
  ;; JUMP 2
  ;; MOVZBL stands for MOVe with Zero Byte extension from Long
  ;; fetches a byte at location (RBX + RAX), pads it with zeroes on left, and stores
  ;; it into ECX
  ;; on first run, this line will take the first byte from the input string and
  ;; store it into ECX
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx ;fetches a byte from (RBX + RAX)
  40108f:	88 0c 24             	mov    %cl,(%rsp)         ;stores the byte onto address at stack top
  401092:	48 8b 14 24          	mov    (%rsp),%rdx        ;stores the byte into RDX
  401096:	83 e2 0f             	and    $0xf,%edx          ;AND the byte with 15
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> ;GOTO JUMP 2
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> ;GOTO JUMP 3
  ;; EXPLODE 2
  4010c6:	e8 6f 03 00 00       	call   40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77> ;GOTO JUMP 3
  ;; JUMP 1
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax ;zeroes EAX
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29> ;GOTO JUMP 2
  ;; JUMP 3
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c> ;GOTO END
  ;; A stack fail? Just before exit? How queer...
  ...
  ;; It seems the phase expects 6 numbers as input. The code can be divided into two
  ;; sections, each performing a different operation.
  ;; The first section of the loop explodes the bomb if any of the numbers are duplicates
  ;; or are greater than 6
  ;; The second section of the loop reverses the position of the given numbers on the
  ;; stack, i.e., if you supplied (123456), it'll change it to (654321).
  ;; The third section stores a linked list of numbers at memory location 0x6032d0.
  ;; Each node of the linked list contains two numbers and a pointer to the next node.
  ;; The numbers contained within it are as follows:
  ;; 332, 168, 924, 691, 477, 443
  ;; The section will map the given numbers (after they were reversed) onto
  ;; this node. So if we started with 123456, which gets reversed to 654321,
  ;; the pair of numbers inside would look like this:
  ;; (6, 332), (5, 168), (4, 924), (3, 691), (2, 477), (1, 443)
  ;; The fourth (and final) section then checks if our mapping leads to a sorted
  ;; list (in descending order).
  ;; So, the correct answer to this problem is to supply the proper indexes as
  ;; input to the function, which is as follows: 432165
00000000004010f4 <phase_6>:
  ;; preserving register context
  4010f4:	41 56                	push   %r14
  4010f6:	41 55                	push   %r13
  4010f8:	41 54                	push   %r12
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp ;allocating space on the stack
  401100:	49 89 e5             	mov    %rsp,%r13  ;RSP = X = R13
  ;; passed the current stack value to read_six_numbers() to store the returned numbers
  401103:	48 89 e6             	mov    %rsp,%rsi
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers> ;reads six numbers
  ;; if we read 6 numbers past this point, then EAX = 6
  ;; also the six read numbers are on the stack right now
  40110b:	49 89 e6             	mov    %rsp,%r14 ;RSP = X + R14
  ;; this zeroing out is usually done to use r12 as an accumulator later on
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d ;R12 = 0 (zeroes out lower 32 bits of R12)

  ;; ======================== SECTION 1 STARTS HERE ==========================
  ;; This section ensures that the provided numbers are less than 7 and are all unique.
  ;; If this is not true, the bomb explodes.
  ;; JUMP 5
  401114:	4c 89 ed             	mov    %r13,%rbp  ;RBP = R13 = X
  ;; loads the first scanned number into EAX (???)
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax      ;EAX = EAX - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax      ;checks if EAX <= 5
  ;; the Bomb explodes if the number is more than 6 (N1 <= 6)
  401121:	76 05                	jbe    401128 <phase_6+0x34> ;GOTO JUMP 1
  ;; EXPLODE 1
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  ;; JUMP 1
  401128:	41 83 c4 01          	add    $0x1,%r12d ;add 1 to the accumulator
  ;; check if all 6 numbers have been scanned
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  ;; GOTO JUMP 2 if all 6 numbers have been scanned
  401130:	74 21                	je     401153 <phase_6+0x5f> ;GOTO JUMP 2
  401132:	44 89 e3             	mov    %r12d,%ebx            ;stores accumulator into EBX
  ;; JUMP 4
  401135:	48 63 c3             	movslq %ebx,%rax             ;stores accumulator into RAX
  ;; loads the next number into EAX(???)
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  ;; is this checking if the next number isn't equal to previous one
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> ;GOTO JUMP 3
  ;; EXPLODE 2
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  ;; JUMP 3
  401145:	83 c3 01             	add    $0x1,%ebx ;increment accumulator
  401148:	83 fb 05             	cmp    $0x5,%ebx
  ;; go back to JUMP 4 and repeat until all 6 numbers have been processed
  40114b:	7e e8                	jle    401135 <phase_6+0x41> ;GOTO JUMP 4
  ;; After this R13 points to the next (???) number scanned from input
  40114d:	49 83 c5 04          	add    $0x4,%r13             ;X = X + 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20> ;GOTO JUMP 5

  ;; ======================== SECTION 2 STARTS HERE ==========================
  ;; This section subtracts each given number from 7 for all 6 input numbers
  ;; So if the input was (1,2,3,4,5,6), it will be (6,5,4,3,2,1) on the stack

  ;; JUMP 2
  ;; at this point, the stack stores the 6 numbers we supplied as input
  ;; the following line stores the stack position just past the 6 numbers into RSI
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi
  401158:	4c 89 f0             	mov    %r14,%rax ;moves the stack pointer to RAX
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx ;set ECX to 7
  ;; JUMP 6
  401160:	89 ca                	mov    %ecx,%edx ;set EDX to 7
  ;; since RAX points the top of the stack where the six numbers are, this line
  ;; subtracts 7 from the first number in the input
  401162:	2b 10                	sub    (%rax),%edx ;EDX = EDX - N1
  401164:	89 10                	mov    %edx,(%rax) ;N1 = EDX
  401166:	48 83 c0 04          	add    $0x4,%rax   ;RAX = N2
  40116a:	48 39 f0             	cmp    %rsi,%rax   ;
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> ;GOTO JUMP 6

  ;; ======================== SECTION 3 STARTS HERE ==========================
  ;; This section contains a reference to a memory location pointed by 0x6032d0
  ;; This location seems to contain 6 nodex. This section "aligns" these 6 nodes
  ;; onto the stack according to the position of the input numbers from the previous
  ;; section.

  40116f:	be 00 00 00 00       	mov    $0x0,%esi             ;zeroes out ESI
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> ;GOTO JUMP 7
  ;; JUMP 8
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx ;
  40117a:	83 c0 01             	add    $0x1,%eax      ;EAX++
  40117d:	39 c8                	cmp    %ecx,%eax      ;ECX != EAX
  40117f:	75 f5                	jne    401176 <phase_6+0x82> ;GOTO JUMP 8
  401181:	eb 05                	jmp    401188 <phase_6+0x94> ;GOTO JUMP 9
  ;; moves into EDX the addess of some static/local variable (???)
  ;; The structure holds these 6 following numbers in it on the first 8 bytes:
  ;; (1, 332), (2, 168), (3, 924), (4, 691), (5, 477), (6, 443)
  ;; (5, 332), (6, 168), (1, 924), (2, 691), (3, 477), (4, 443)

  ;; The structure is a linked list, each storing 1 number, 1 index, and 1 pointer
  ;; to the next element
  ;; JUMP 10
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx ;moves some constant into EDX
  ;; JUMP 9
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> ;GOTO JUMP 15
  ;; JUMP 7
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx ;stores N1 into ECX
  40119a:	83 f9 01             	cmp    $0x1,%ecx          ;N1 <= 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> ;GOTO JUMP 10
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax             ;EAX = 1
  ;; WHAT IS STORED AT 0x6032d0???
  ;; IT IS A LINKED LIST!!!
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx        ;moves something in EDX
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> ;GOTO JUMP 8

  ;; ======================== SECTION 4 STARTS HERE ==========================
  ;; AM I SUPPOSED TO STACK SMASH WITH MY INPUT???
  ;; JUMP 15
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  ;; a double pointer reference (???)/ basically stores **to a value in the node struct
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax
  ;; setting a bound value for iteration (???)
  ...
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> ;GOTO JUMP 11
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> ;GOTO JUMP 12
  ;; JUMP 11
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> ;GOTO JUMP 13
  ;; EXPLODE 3
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  ;; JUMP 13
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011f2:	83 ed 01             	sub    $0x1,%ebp
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> ;GOTO JUMP 14
...
0000000000401242 <secret_phase>:
  ...
  ;; input stored in RAX
  401248:	ba 0a 00 00 00       	mov    $0xa,%edx ;EDX = 10 (base)
  40124d:	be 00 00 00 00       	mov    $0x0,%esi ;ESI = endptr
  401252:	48 89 c7             	mov    %rax,%rdi ;moves RAX into RDI for function call
  ;; strtol() would real a long
  401255:	e8 76 f9 ff ff       	call   400bd0 <strtol@plt>
  40125a:	48 89 c3             	mov    %rax,%rbx ;stores result into RBX
  ;; Subtracts 1 from input string and zeroes the leading 32 bits of the input value (???)
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  401265:	76 05                	jbe    40126c <secret_phase+0x2a> ;GOTO JUMP 1
...
000000000040143a <explode_bomb>:
  ...
  ;; Reads six numbers, each separated by spaces
  ;; format it expects is (%d %d %d %d %d %d)
000000000040145c <read_six_numbers>:
  ;; allocates 24 quads on the stack
  40145c:	48 83 ec 18          	sub    $0x18,%rsp
  ;; moves rsi (second argument to function) into rdx
  401460:	48 89 f2             	mov    %rsi,%rdx
  ;; offset rsi by 4 bytes and store the result into rcx
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx
  ;; offset rsi by 20 bytes and store the result into rax
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  ;; offset stack pointer by 8 bytes and store the value of rax there
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
  ;; offset rsi by 16 bytes and store the result into rax
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  ;; store the value of rax at the top of the stack
  401474:	48 89 04 24          	mov    %rax,(%rsp)
  ;; offset rsi by 12 bytes and store the value in r9
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9
  ;; offset rsi by 8 bytes and store the value in r8
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8
  ;; the line below is the format string as the constant 0x4025c3
  ;; when read as (char *) translates to "%d %d %d %d %d %d"
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi
  ;; %eax is zeroed out before the call to sscanf()
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  ;; calls sscanf()
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  ;; since eax here stores the return value from sscanf, it means that scanf
  ;; needs to return a values > 5 for a successful return
  40148f:	83 f8 05             	cmp    $0x5,%eax
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d>
  ;; otherwise bomb explodes
  ;; but why explode the bomb here when there's an explode bomb right after
  ;; this function returns?
  ;; Is this just a safeguard to prevent you from skipping to the return?
...
00000000004015c4 <phase_defused>:
  ...
  ;; stores some really large negative number into RAX
  4015c8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  4015cf:	00 00
  ;; stores this number on the stack
  4015d1:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
  ;; XORs EAX to zero it (???)
  4015d6:	31 c0                	xor    %eax,%eax
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings>
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b> ;GOTO JUMP 1
  ...
  401602:	75 31                	jne    401635 <phase_defused+0x71> ;GOTO JUMP 2
  401604:	be 22 26 40 00       	mov    $0x402622,%esi
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  40160e:	e8 25 fd ff ff       	call   401338 <strings_not_equal>
  401613:	85 c0                	test   %eax,%eax
  401615:	75 1e                	jne    401635 <phase_defused+0x71> ;GOTO JUMP 2
  ...
  40164b:	00 00 
  40164d:	74 05                	je     401654 <phase_defused+0x90> ;GOTO END
